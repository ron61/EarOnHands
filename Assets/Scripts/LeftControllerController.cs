...
public class LeftControllerController : MonoBehaviour {
    ...
    public static bool isLeftRadioHidden;
    public static bool isLeftBottleHidden;
    ...
    void Update () {
        ...
        //check if the grip button is pushed or not
        ...
        if (Physics.Raycast(trackedObj.transform.position, radio.transform.position - trackedObj.transform.position, out hit, Mathf.Infinity))
        {
            ...
            {
                //Debug.Log("left radio filter");
                isLeftRadioHidden = true;
            }
            else
            {
                isLeftRadioHidden = false;
            }
        }
        ...
        if (Physics.Raycast(trackedObj.transform.position, bottle.transform.position - trackedObj.transform.position, out hit, Mathf.Infinity))
        {
            ...
            {
                //Debug.Log("left bottle filter");
                isLeftBottleHidden = true;
            }
            else
            {
                isLeftBottleHidden = false;
            }
        }
    }
